...
def calc_accuracy(model, dataloader, packet_len, device):
    ...
    return calc_mean_accuracy(original_messages_cpu, reconstructed_message_cpu, packet_len)


def calc_mean_accuracy(original_messages_cpu, reconstructed_message_cpu, packet_len):
